...
const BLUR_PX = 8
// filter: blur() 가장자리 페이드를 보이는 영역 밖으로 밀어내려고, 흐린 이미지 전체를 살짝
// 확대해서 그린다. transform은 filter/mask가 적용된 결과물을 그대로 확대만 하는 거라(마스크가
// 자기 박스 기준 100%로 맞춰져 있으므로) 마스크와의 정렬은 흐트러지지 않는다.
const BLUR_SCALE = 1.0
