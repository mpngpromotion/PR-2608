  ...
  return (
    <html lang='ko' className='antialiased'>
      <head>
        ...
        <link
          rel='stylesheet'
          href='https://o6cdhdutve.execute-api.ap-northeast-2.amazonaws.com/v1/api/css/drop_fontstream_css/?sid=gAAAAABqhpSYEIuZhXW6w9aiAYVO0xUYOCrXnWJuR211hA_Dkt3w1Yd7WXbxNwlbxte6tWADB1YOcnJ9KoBUKkxOGSvJcgwNXQXxOOTzxPfJSJ_qOd7QJmlVRfkKEbaGoTPoJkt7RU23l4Zj6EBrEPUKdI7lp8SKxq9lHNxwEjgGiBEPu1YhoB2N8r7gfWoV9lPo37YvKU62X-OwwYdSQNv3q7CZro7rv9hW0pefL2QK8T7vIkSTTQJNKCL2RmfxCbhQt9ilZqyI'
          charSet='utf-8'
          referrerPolicy='origin'
        ></link>
      </head>
      <body>
        <Layout landing>{children}</Layout>
